          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.summaryCards}>
              <div className={styles.summaryCard}>
                <span className={styles.summaryNum}>{dryRunResult.evaluated_count}</span>
                <span className={styles.summaryLabel}>评估实例</span>
              </div>
              <div className={styles.summaryCard}>
                <span className={styles.summaryNum} style={{ color: 'var(--warn)' }}>
                  {dryRunResult.acted_count}
                </span>
                <span className={styles.summaryLabel}>拟执行动作</span>
              </div>
              <div className={styles.summaryCard}>
                <span className={styles.summaryNum} style={{ color: 'var(--err)' }}>
                  {dryRunResult.failed_count}
                </span>
                <span className={styles.summaryLabel}>异常数</span>
              </div>
              <div className={styles.summaryCard}>
                <span className={styles.summaryNum}>{dryRunResult.duration_ms}ms</span>
